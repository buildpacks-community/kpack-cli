	...
	when("#GetClusterBuilders", func() {
		it("returns the cluster builders and the default cluster builder", func() {
			...
			expectedBuilders := []importpkg.ClusterBuilder{
				{Name: "some-cb", ClusterStack: "some-stack", ClusterStore: "some-store", Order: []v1alpha2.OrderEntry{{Group: []v1alpha2.BuildpackRef{{BuildpackInfo: v1alpha2.BuildpackInfo{Id: "some-buildpack", Version: "1.2.3"}, Optional: false}}}}},
				{Name: "default", ClusterStack: "some-stack", ClusterStore: "some-store", Order: []v1alpha2.OrderEntry{{Group: []v1alpha2.BuildpackRef{{BuildpackInfo: v1alpha2.BuildpackInfo{Id: "some-buildpack", Version: "1.2.3"}, Optional: false}}}}},
			}
